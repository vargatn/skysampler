...
class FeatureSpaceContainer(object):
    ...
    def get_weights(self):
        """Calculates weights from ratio of Number profile"""
        pass
...
class MultiEyeballer(object):
    _radial_splits = [0, 0.5, 2, 5, 10, 30]
    _diagrams = ["c-c", "c-m", "radial"]
    def __init__(self):
        """
