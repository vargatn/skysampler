...
class SurveyIndexer(object):
    # TODO benchmark this data


    # TODO Add functionality to save min(N, N_max) random samples
    # TODO add functionality to re-draw these objects
...
class IndexedDataContainer(object):
    ...
    def drop_data(self):
        ...
        self.survey = self.survey.lean_copy()
