...
tag_root = "epsilon_concentric_sample_v14-highz"
NREPEATS = 10
NSAMPLES = 1500000
NCHUNKS = 150
...
deep_c_settings = {
    "columns": [
        ("MAG_I", ("bdf_mag_dered", 3)),
        ("COLOR_R_I", (("bdf_mag_dered", 2), ("bdf_mag_dered", 3), "-")),
        ("COLOR_I_Z", (("bdf_mag_dered", 3), ("bdf_mag_dered", 4), "-")),
    ],
...
columns = {
    "cols_dc": ["COLOR_R_I", "COLOR_I_Z",],
    "cols_wr": ["LOGR",],
    "cols_wcr": ["COLOR_R_I", "COLOR_I_Z", "LOGR",],
}
    ...
    for run_tag in run_tags:
        ...
        for nrep in np.arange(NREPEATS):
            ...
            for i in np.arange(nrbins):
                ...
                _wide_r_settings_clust = emulator.construct_wide_container(mdl_clust, tmp_wide_r_settings,
                ...
                # create infodicts
                infodicts, samples = emulator.make_classifier_infodicts(_wide_cr_settings_clust, _wide_r_settings_clust,
